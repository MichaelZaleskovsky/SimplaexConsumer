...
public class TCPProducer {
	 ...
	 public static void main(String argv[]) {
		 ...
		 String[] test = {
				...
				"0977dca4-9906-3171-bcec-87ec0df9d745,uZNIcWQtwst+9mjQgPkV2rvm7QY=,0.039107542861771316,280709214,asdfghjk",
				"0977dca4-9906-3171-bcec-87ec0df9d745,9ZWcYIblJ7ebN5gATdzzi4e8K7Q=,0.9655429720343038,237475359,3923415930815531861",
				"4d968baa-fe56-3ba0-b142-be9f457c9ff4,RnJNTKLYpcUqhjOey+wEIGHC7aw=,0.6532229483547558,1445676285,4756900066502959030",
				"0977dca4-9906-3171-bcec-87ec0df9d745,9ZWcYIblJ7ebN5gATdzzi4e8K7Q=,0.9655429720343038,237475359,3923415930816731861",
				"4d968baa-fe56-3ba0-b142-be9f457c9ff4,RnJNTKLYpcUqhjOey+wEIGHC7aw=,0.6532229483547558,1403876285,4756900066502959030"
		 };
		...
		try {
			ServerSocket serverSocket = new ServerSocket(9000);
				   ...
				   socketOutput = new PrintStream(connectionSocket.getOutputStream());
			for (int i = 0; i < test.length; i++) {
			   System.out.println("While going ");
			   socketOutput.println(test[i]);
		    }
		} catch (IOException e) {
